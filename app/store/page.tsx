...
export default function StorePage() {
  ...
  const moves = useMemo(() => {
    const safeMoves = Array.isArray(localMoves) ? localMoves : []
    const safeInts = Array.isArray(allInterventions) ? allInterventions : []
    const fromInts = safeInts.flatMap((i: any) =>
    ...
    return [...safeMoves, ...fromInts].sort((a: any, b: any) => b.date > a.date ? 1 : -1)
