...
const NAV_ITEMS = [
  ...
  { href: '/preventive',    label: 'Préventif',      icon: 'preventive', roles: ['admin','chef','technician'] },
...
const ICONS: Record<string, string> = {
  ...
  preventive: 'M12 2a10 10 0 100 20A10 10 0 0012 2zm0 5v5l4 2M8 2h8',
}
  ...
  if (loading) return (
    <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#080909' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
        <img src="/logo.png" alt="MaintaFood" style={{ height: 80, objectFit: 'contain' }} />
  ...
  return (
    <div style={{ display: 'flex', height: '100dvh', overflow: 'hidden', fontFamily: 'var(--font-outfit)' }}>
      ...
      <aside style={{
        ...
        {/* Logo */}
        <div style={{ padding: '16px 14px 14px', borderBottom: '1px solid rgba(255,255,255,.04)' }}>
          <img src="/logo.png" alt="MaintaFood" style={{ width: '100%', objectFit: 'contain', objectPosition: 'left' }} />
          <div style={{ fontSize: 9, fontFamily: 'var(--font-mono)', color: '#3a4055', marginTop: 6, textTransform: 'uppercase', letterSpacing: '.6px' }}>
            GMAO Platform
          </div>
        </div>
